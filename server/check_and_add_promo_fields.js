...
async function checkAndAddPromoFields() {
    try {
        ...
        console.log('✅ All promo fields have been added successfully!');
        console.log('✅ Database is ready for promo feature');
        
        return true;
    } catch (error) {
        console.error('❌ Error checking/adding promo fields:', error.message);
        throw error;
    }
}

// Run the migration
checkAndAddPromoFields()
    .then(() => {
